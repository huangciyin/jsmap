...
OvMap.prototype = Object.extend(new Abstract.Control(), {
    ...
    drawOvContainer: function (container) {
        ...
        this.ovMapDiv = Util.createDiv(this.id, left, top, width, height, null, 'absolute', '1px ridge #666666');
        this.ovMapDiv.style.overflow = 'hidden'
        this.ovMapDiv.style.backgroundImage = 'url(' + ImageBaseDir + 'iaspec_bottom.png)';
        this.ovMapDiv.style.backgroundColor = "#f5f5f5";
        ...
        this.rectDiv.style.cursor = "hand";
        this.ovMapDiv.appendChild(this.rectDiv);
        this.registerEvent(this.rectDiv, 'rect_', 'mousedown,mousemove,mouseup');


        this.panDiv = Util.createDiv(Util.createUniqueID('Ov_Pan_'), null, null, null, null, ImageBaseDir + 'ov_pan_down.gif', 'absolute');
        this.panDiv.style.zIndex = 100000;
        this.panDiv.style.left = containerWidth - 21 + "px";
        this.panDiv.style.top = containerHeight - 21 + "px";
    ...
    rect_mousedown: function (e) {
        ...
        this.rectTempDiv.style.cursor = "hand";
